     ...
     <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            <div class="navbar-nav w-100">
                <a href="inputdatakub.php" class="navbar-brand mx-3 mb-3">
                    <img src="img/logodkp.png" width="200" height="50" class="d-inline-block align-text-top align-items-center">
                </a>
                <a href="dasadmin.php" class="nav-link "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                <a href="inputdatakub.php" class="nav-link active"><i class="fa fa-laptop me-2"></i>Input Data</a>
            </div>
        </nav>
    </div>
        <!-- Sidebar End -->
            ...
            <div class="modal-dialog modal-lg">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="id">
                                ...
                                <div class="mb-3">
                                    <label for="b_kabkota" class="col-form-label">Bantuan Kabupaten/Kota:</label>
                                    <input type="text" class="form-control" id="b_kabkota" name="b_kabkota">
                                </div>
                                <div class="mb-3">
                                    <label for="b_prvo" class="col-form-label">Bantuan PRVO:</label>
                                    <input type="text" class="form-control" id="b_prvo" name="b_prvo">
                                </div>
                                <div class="mb-3">
                                    <label for="b_kkp" class="col-form-label">Bantuan KKP:</label>
                                    <input type="text" class="form-control" id="b_kkp" name="b_kkp">
                                </div>
                                <div class="mb-3">
                                    <label for="belum" class="col-form-label">Belum Dikategorikan:</label>
                                    <input type="text" class="form-control" id="belum" name="belum">
                                </div>
